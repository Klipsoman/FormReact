import style from "./ModalConf.module.css";
...
const ModalConf = () => {
  ...
  function closeModal(e) {
    ...
    if (e.target.type == "submit") {
      dispatch(succesConfidential(true));
    }
    dispatch(changeConfidentialModalVisible(!modals.isModalConfidentialOpen));
  }

  return (
    <div
      className={
        modals.isModalConfidentialOpen
          ? style.modalActive + " modal " + style.modal
          : "modal " + style.modal
      }
      onClick={closeModal}
    >
      <div className={style.modalContent}>
        ...
        <div className={style.modalBody}>
          <p>
            ...
            <br /> Настоящая политика обработки персональных данных составлена в
            ...
            веб-сайта httpsː//thismywebsite·com; <br />
            ...
            <br /> 3.4. Также на сайте происходит сбор и обработка обезличенных
            ...
            электронной почты privacy@thismywebsite·com с пометкой «Отказ от
            ...
            содержания.
            <br /> 5. Правовые основания обработки персональных данных <br />
            ...
            персональных данных».
            <br /> 6.4. Срок обработки персональных данных является
